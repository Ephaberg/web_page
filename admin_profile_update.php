<?php
    ...
    if(isset($_POST['update'])){
        ...
        $previous_pass = filter_var($previous_pass, PASSWORD_DEFAULT);
        $new_pass = md5($_POST['new_pass']);
        $new_pass = filter_var($new_pass, PASSWORD_DEFAULT);
        $confirm_pass = md5($_POST['confirm_pass']);
        $confirm_pass = filter_var($confirm_pass, PASSWORD_DEFAULT);
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    ...
                    <input type="password" class="box" name="Old_pass" placeholder="Enter Old Password" >
